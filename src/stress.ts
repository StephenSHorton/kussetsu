...
import { Painter, type GlassPanel, type TextItem } from "./webgpu";
...
export async function runStress(canvas: HTMLCanvasElement, a11yHost: HTMLElement) {
  ...
  function renderOnce() {
    ...
    const glass: GlassPanel[] = [
      { x: lens.x, y: lens.y, w: lens.w, h: lens.h, radius: 28, refraction: 0.13, frost: 5, tint: 0.07, tintColor: [0.82, 0.87, 1, 1], rim: 30 },
    ];
    sem.push({
      id: "lens",
